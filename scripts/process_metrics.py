...
def pytest_runtest_makereport(item, call):
    """
    Hook to capture screenshots on any test failure (setup, call, teardown)
    """
    # Let pytest run other hooks and get the test report
    outcome = yield
    ...
    if report.failed:
        ...
        if page:
            ...
            filename = f"{int(time.time())}_{safe_nodeid}.png"
            ...
            try:
                ...
                # Attach screenshot path to report for metrics processing
